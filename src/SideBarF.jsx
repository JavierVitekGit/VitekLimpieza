   ...
   {/* <BrowserRouter> */}
    ...
    <div className="lista">
                <div className="section1">
                 ...
                 <div className="turno">
        <Link to="/Anadir Turno F">        <p className="turno" onClick={turno}>Añadir Turno</p></Link>
                 </div>
        ...
        <Link to ="/Alta del Operador F">   <p className="alta-op" onClick={Operador}>Alta del Operador</p></Link>
        </div>

                <div className="baja-op">
        <Link to="/Baja del Operador F">    <p className="baja-op" onClick={bajaOperador}>Baja del Operador</p></Link>           
                </div>



                <div className="reasignacionn">
        <Link to="/Reasignacion F"> <p className="reasignacion-op" onClick={Reasignacion}>Reasignación</p></Link>
                </div>

                <div className="cambio">
        <Link to="/Cambio de Numero F"> <p className="cambioN" onClick={Numero}>Cambio de Número</p></Link>
                </div>
        ...
        <Link to="/Inasistencia F"> <p className="registroIn" onClick={Inasistencia}>Inasistencias</p> </Link>    
        ...
        <Link to="/Calendario F"> <p className="registro" onClick={Registro}>Justificaciones</p> </Link>    
