                                                ...
                                                justificaciones.forEach((iter)=>{
                                                   ...
                                                   item.dias.forEach((dialokobydiego)=>{
                                                    ...
                                                    // console.log(item.Nombre+"=="+iter.Nombre);
                                                        ...
                                                        // console.log("DaysSubstring",+Object.keys(dialokobydiego)[0].slice(-2))

                                                        if (item.Horario == iter.Turno && item.Nombre == iter.Nombre && item.Cliente == iter.Cliente && +iter.Fecha.substring(0,2) == +Object.keys.slice(-2)(dialokobydiego)[0] ) {
