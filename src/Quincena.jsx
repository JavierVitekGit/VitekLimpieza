                                                ...
                                                justificaciones.forEach((iter)=>{
                                                   ...
                                                   item.dias.forEach((dialokobydiego)=>{
                                                    ...
                                                    // console.log(item.Nombre+"=="+iter.Nombre);
                                                        ...
                                                        // console.log("nsubstring",n.substring(0,2))
                                                        // console.log("NyxSubstring",nyx.substring(0,2))

                                                        console.log("DaysSubstring",+Object.keys(dialokobydiego.substring(-2))[0])

                                                        if (item.Horario == iter.Turno && item.Nombre == iter.Nombre && item.Cliente == iter.Cliente && +iter.Fecha.substring(0,2) == +Object.keys(dialokobydiego.substring(-2))[0] ) {
