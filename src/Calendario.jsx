  ...
  // if (hora >= item.hr.substr(0,2)  ) {
    ...
    <td>
      <div id="hidden">
        ...
        <input type="radio" name={nameOne} value="Si" onClick={mostrarDiv} onChange={v=>item.radio = v.target.value} ></input> 
        {/* <label class="form-outline-label">Si</label> */}
        <br/>
        ...
        <input type="radio" name={nameOne} value="No" onClick ={ocultarDiv} ></input>
        {/* <label class="form-outline-label">No</label> */}
