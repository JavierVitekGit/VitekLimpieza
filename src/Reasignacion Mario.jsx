...
const ReasignacionM = (reasignacion) => {
    ...
    let config = {
      ...
      useLayoutEffect(()=>{
        ...
        clientCl.push(
          ...
          "TelcelCADQueretaro",
          "TelcelCACQueretaroI",
          "TelcelCACQueretaroVI",
          "TelcelCACQueretaroXI",
          "Andrea5Febrero",
...
<div className="SideOlgaB">
      ...
      <div className="roH">
        ...
        <i id="ri" class="bi bi-arrow-down-up"></i>
          Reasignación del Operador Mario
          </h1>
    ...
    <div className="container">
        ...
        <select onClick={forceUpdate} value={cliente} onChange={v=>{setCliente(v.target.value)}}>
            ...
            {clientCl.map((item,i)=> <option>{item}</option>)}
